...
keywords_to_delete=(
    ...
    "smartdns" "kucat" "bootstrap" "uugamebooster" "luci-app-wol" "luci-i18n-wol-zh-cn" "CONFIG_TARGET_INITRAMFS" "ddns" "LSUSB" "mihomo"
    "dockerd" "docker" "containerd" "runc" "tini" "luci-app-dockerman" "luci-i18n-dockerman-zh-cn"
)
